...
// node_modules/lamina/node_modules/@radix-ui/react-tooltip/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-context/dist/index.module.js
...
// node_modules/@radix-ui/react-dismissable-layer/node_modules/@radix-ui/react-use-escape-keydown/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-id/dist/index.module.js
var $2AODx$react = __toESM(require_react());

// node_modules/lamina/node_modules/@radix-ui/react-use-layout-effect/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-popper/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-arrow/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-use-size/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-presence/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-slot/dist/index.module.js
var import_react15 = __toESM(require_react());
var $5e63c961fc1ce211$export$8c6ed5c666ac13602 = (0, import_react15.forwardRef)((props3, forwardedRef) => {
  const { children, ...slotProps } = props3;
...
var $5e63c961fc1ce211$var$SlotClone2 = (0, import_react15.forwardRef)((props3, forwardedRef) => {
  const { children, ...slotProps } = props3;
...
// node_modules/lamina/node_modules/@radix-ui/react-use-controllable-state/dist/index.module.js
...
// node_modules/lamina/node_modules/@radix-ui/react-visually-hidden/dist/index.module.js
...
var $a093c7e1ec25a057$var$TooltipContentImpl = (0, import_react18.forwardRef)((props3, forwardedRef) => {
  ...
  }), (0, import_react18.createElement)($5e63c961fc1ce211$export$d9f1ccf0bdb05d452, null, children), (0, import_react18.createElement)($a093c7e1ec25a057$var$VisuallyHiddenContentContextProvider, {
    scope: __scopeTooltip,
    isInside: true
...
function $a093c7e1ec25a057$var$getHullPresorted(points) {
  ...
  for (let i = 0; i < points.length; i++) {
    ...
    while (upperHull.length >= 2) {
      ...
      if ((q2.x - r.x) * (p.y - r.y) >= (q2.y - r.y) * (p.x - r.x))
        upperHull.pop();
      else
        break;
    }
...
var clamp = (x, min3, max3) => x > max3 ? max3 : x < min3 ? min3 : x;
var parseNumber = (v) => {
...
var range = (v, min3, max3) => {
  if (max3 === min3)
    return 0;
  const _v = clamp(v, min3, max3);
  return (_v - min3) / (max3 - min3);
};
var invertedRange = (p, min3, max3) => p * (max3 - min3) + min3;
...
function NumberInput(_ref2) {
  ...
  const _onUpdate = (0, import_react19.useCallback)((v) => onUpdate(parseNumber(v)), [onUpdate]);
...
function RawLabel(props3) {
  ...
  return import_react19.default.createElement(import_react19.default.Fragment, null, optional && import_react19.default.createElement(OptionalToggle, null), hint !== void 0 ? import_react19.default.createElement($a093c7e1ec25a057$export$be92b6f5f03c0fe9, null, import_react19.default.createElement($a093c7e1ec25a057$export$41fb9f06171c75f4, {
    asChild: true
...
function useInputSetters({
  ...
  const setFormat = (0, import_react19.useCallback)((v) => setDisplayValue(format$2(type, v, settingsRef.current)), [type]);
...
function RangeSlider({
  ...
  const bind = useDrag2(({
    ...
    if (first) {
      ...
      memo = targetIsScrub ? value : invertedRange((x - left) / width, min3, max3);
    }
...
function Vector({
  ...
  }), Object.keys(value).map((key, i) => import_react19.default.createElement(Coordinate, {
    id: i === 0 ? id : `${id}.${key}`,
    key,
    valueKey: key,
    value,
...
var useVisiblePaths = (store) => {
  const [paths, setPaths] = (0, import_react22.useState)(store.getVisiblePaths());
  (0, import_react22.useEffect)(() => {
...
function usePopin(margin = 3) {
  const popinRef = (0, import_react22.useRef)(null);
  const wrapperRef = (0, import_react22.useRef)(null);
  const [shown, setShow] = (0, import_react22.useState)(false);
  const show = (0, import_react22.useCallback)(() => setShow(true), []);
  const hide2 = (0, import_react22.useCallback)(() => setShow(false), []);
  (0, import_react22.useLayoutEffect)(() => {
    if (shown) {
      const {
        bottom,
...
function Color2({
  ...
  const timer = (0, import_react22.useRef)(0);
  const [initialRgb, setInitialRgb] = (0, import_react22.useState)(() => convertToRgb(value, format3));
  ...
  return import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(ColorPreview, {
    ref: popinRef,
    active: shown,
    onClick: () => showPicker(),
    style: {
  ...
  }), shown && import_react22.default.createElement(Portal, null, import_react22.default.createElement(Overlay, {
    onPointerUp: hidePicker
  }), import_react22.default.createElement(PickerWrapper, {
    ref: wrapperRef,
    onMouseEnter: () => window.clearTimeout(timer.current),
    onMouseLeave: (e) => e.buttons === 0 && hideAfterDelay()
  }, import_react22.default.createElement(ColorPicker, {
    color: initialRgb,
    onChange: onUpdate
  }))));
}
function ColorComponent() {
  ...
  return import_react22.default.createElement(Row, {
    input: true
  }, import_react22.default.createElement(Label, null, label), import_react22.default.createElement(PickerContainer, null, import_react22.default.createElement(Color2, {
    value,
    displayValue,
    onChange,
    onUpdate,
    settings
  }), import_react22.default.createElement(ValueInput, {
    value: displayValue,
    onChange,
    onUpdate
  })));
...
function Vector3dComponent() {
  ...
  return import_react22.default.createElement(Row, {
    input: true
  }, import_react22.default.createElement(Label, null, label), import_react22.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  }));
...
function Joystick({
  ...
  const timeout = (0, import_react22.useRef)();
  const outOfBoundsX = (0, import_react22.useRef)(0);
  const outOfBoundsY = (0, import_react22.useRef)(0);
  const stepMultiplier = (0, import_react22.useRef)(1);
  const [joystickShown, setShowJoystick] = (0, import_react22.useState)(false);
  const [isOutOfBounds, setIsOutOfBounds] = (0, import_react22.useState)(false);
  const [spanRef, set] = useTransform();
  const joystickeRef = (0, import_react22.useRef)(null);
  const playgroundRef = (0, import_react22.useRef)(null);
  (0, import_react22.useLayoutEffect)(() => {
    if (joystickShown) {
      const {
        top,
  ...
  const startOutOfBounds = (0, import_react22.useCallback)(() => {
    if (timeout.current)
      return;
  ...
  const endOutOfBounds = (0, import_react22.useCallback)(() => {
  ...
  return import_react22.default.createElement(JoystickTrigger, _extends2({
    ref: joystickeRef
  }, bind()), joystickShown && import_react22.default.createElement(Portal, null, import_react22.default.createElement(JoystickPlayground, {
    ref: playgroundRef,
    isOutOfBounds
  }, import_react22.default.createElement("div", null), import_react22.default.createElement("span", {
    ref: spanRef
  }))));
}
...
function Vector2dComponent() {
  ...
  return import_react22.default.createElement(Row, {
    input: true
  }, import_react22.default.createElement(Label, null, label), import_react22.default.createElement(Container$1, {
    withJoystick: !!settings.joystick
  }, settings.joystick && import_react22.default.createElement(Joystick, {
    value: displayValue,
    settings,
    onUpdate
  }), import_react22.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  })));
...
function ImageComponent() {
  ...
  const onDrop = (0, import_react22.useCallback)((acceptedFiles) => {
    if (acceptedFiles.length)
      onUpdate(acceptedFiles[0]);
  }, [onUpdate]);
  const clear = (0, import_react22.useCallback)((e) => {
    e.stopPropagation();
    onUpdate(void 0);
  }, [onUpdate]);
  const {
  ...
  return import_react22.default.createElement(Row, {
    input: true
  }, import_react22.default.createElement(Label, null, label), import_react22.default.createElement(ImageContainer, null, import_react22.default.createElement(ImagePreview, {
    ref: popinRef,
    hasImage: !!value,
  ...
  }), shown && !!value && import_react22.default.createElement(Portal, null, import_react22.default.createElement(Overlay, {
    onPointerUp: hide2,
    style: {
      cursor: "pointer"
    }
  }), import_react22.default.createElement(ImageLargePreview, {
    ref: wrapperRef,
    style: {
      backgroundImage: `url(${value})`
    }
  })), import_react22.default.createElement(DropZone, getRootProps({
    isDragAccept
  }), import_react22.default.createElement("input", getInputProps()), import_react22.default.createElement(Instructions, null, isDragAccept ? "drop image" : "click or drop")), import_react22.default.createElement(Remove, {
    onClick: clear,
    disabled: !value
  })));
}
...
function IntervalSlider(_ref) {
  ...
  const minScrubberRef = (0, import_react22.useRef)(null);
  const maxScrubberRef = (0, import_react22.useRef)(null);
  const rangeWidth = (0, import_react22.useRef)(0);
  const scrubberWidth = useTh("sizes", "scrubberWidth");
  const bind = useDrag2(({
    event,
    first,
    ...
    if (first) {
      ...
      _memo.pos = invertedRange((x - left) / width, min3, max3);
  ...
  return import_react22.default.createElement(RangeWrapper, _extends2({
    ref
  }, bind()), import_react22.default.createElement(Range, null, import_react22.default.createElement(Indicator, {
    style: {
      left: minStyle,
      right: maxStyle
    }
  })), import_react22.default.createElement(Scrubber, {
    position: "left",
    ref: minScrubberRef,
    style: {
      left: minStyle
...
function IntervalComponent() {
  ...
  return import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(Row, {
    input: true
  }, import_react22.default.createElement(Label, null, label), import_react22.default.createElement(Container2, null, import_react22.default.createElement(IntervalSlider, _extends2({
    value: displayValue
  }, settings, {
    onDrag: onUpdate
  })), import_react22.default.createElement(Vector, {
...
function useCreateStore() {
  return (0, import_react22.useMemo)(() => new Store(), []);
}
...
function ControlInput(_ref) {
  ...
  return import_react22.default.createElement(InputContext.Provider, {
  ...
  }, import_react22.default.createElement(StyledInputWrapper$1, {
    disabled
  }, import_react22.default.createElement(Input, null)));
}
...
function Button({
  ...
  const store = useStoreContext();
  return import_react22.default.createElement(Row, null, import_react22.default.createElement(StyledButton, {
...
function ButtonGroup(props3) {
  ...
  return import_react22.default.createElement(Row, {
    input: !!label
  }, label && import_react22.default.createElement(Label, null, label), import_react22.default.createElement(StyledButtonGroup, null, Object.entries(opts).map(([label2, onClick]) => import_react22.default.createElement(StyledButtonGroupButton, {
    key: label2,
    onClick: () => onClick(store.get)
  }, label2))));
}
...
var MonitorCanvas = (0, import_react22.forwardRef)(function({
  initialValue
}, ref) {
  ...
  const [gradientTop, gradientBottom] = (0, import_react22.useMemo)(() => {
    return [w(fillColor).alpha(0.4).toRgbString(), w(fillColor).alpha(0.1).toRgbString()];
  }, [fillColor]);
  const points = (0, import_react22.useRef)([initialValue]);
  const min3 = (0, import_react22.useRef)(initialValue);
  const max3 = (0, import_react22.useRef)(initialValue);
  const raf = (0, import_react22.useRef)();
  const drawPlot = (0, import_react22.useCallback)((_canvas, _ctx) => {
    if (!_canvas)
      return;
    const {
      width,
    ...
    for (let i = 0; i < points.current.length; i++) {
      const p = range(points.current[i], min3.current, max3.current);
      const x = interval2 * i;
  ...
  (0, import_react22.useEffect)(() => () => cancelAnimationFrame(raf.current), []);
  return import_react22.default.createElement(Canvas, {
    ref: canvas
  });
});
var parse = (val) => Number.isFinite(val) ? val.toPrecision(2) : val.toString();
var MonitorLog = (0, import_react22.forwardRef)(function({
  initialValue
}, ref) {
  const [val, set] = (0, import_react22.useState)(parse(initialValue));
  (0, import_react22.useImperativeHandle)(ref, () => ({
    frame: (v) => set(parse(v))
  }), []);
  return import_react22.default.createElement("div", null, val);
});
function getValue(o) {
...
function Monitor({
  ...
  const ref = (0, import_react22.useRef)();
  const initialValue = (0, import_react22.useRef)(getValue(objectOrFn));
  (0, import_react22.useEffect)(() => {
  ...
  return import_react22.default.createElement(Row, {
    ...
    align: "top"
  }, label), settings.graph ? import_react22.default.createElement(MonitorCanvas, {
    ref,
    initialValue: initialValue.current
  }) : import_react22.default.createElement(MonitorLog, {
    ref,
    initialValue: initialValue.current
  }));
}
...
var Control = import_react22.default.memo(({
  path
}) => {
  const [input, {
    set,
  ...
  if (type in SpecialInputs) {
    ...
    return import_react22.default.createElement(SpecialInputForType, _extends2({
      label,
      path
    }, inputProps));
  }
  ...
  return import_react22.default.createElement(ControlInput, _extends2({
    key: storeId + path,
    type,
    label,
    storeId,
...
function FolderTitle({
  ...
  return import_react22.default.createElement(StyledTitle, {
    onClick: () => toggle()
  }, import_react22.default.createElement(Chevron, {
    toggled
  }), import_react22.default.createElement("div", null, name));
}
var Folder = ({
  name,
  path,
  ...
  const [toggled, setToggle] = (0, import_react22.useState)(!collapsed);
  const folderRef = (0, import_react22.useRef)(null);
  ...
  return import_react22.default.createElement(StyledFolder, {
    ref: folderRef
  }, import_react22.default.createElement(FolderTitle, {
    name,
    toggled,
    toggle: () => setToggle((t) => !t)
  }), import_react22.default.createElement(TreeWrapper, {
    parent: newPath,
    tree,
    toggled
  }));
};
var TreeWrapper = import_react22.default.memo(({
  ...
  return import_react22.default.createElement(StyledWrapper, {
    ref: wrapperRef,
    isRoot: _isRoot,
    fill: _fill,
    flat: _flat
  }, import_react22.default.createElement(StyledContent, {
    ref: contentRef,
    isRoot: _isRoot,
    toggled
  }, entries.map(([key, value]) => isInput(value) ? import_react22.default.createElement(Control, {
    key: value.path,
    valueKey: value.valueKey,
    path: value.path
  }) : import_react22.default.createElement(Folder, {
    key,
    name: key,
    path: parent,
    tree: value
...
var FilterInput = import_react22.default.forwardRef(({
  setFilter,
  toggle
}, ref) => {
  const [value, set] = (0, import_react22.useState)("");
  const debouncedOnChange = (0, import_react22.useMemo)(() => debounce(setFilter, 250), [setFilter]);
  const clear = () => {
    setFilter("");
    set("");
  };
  ...
  return import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(StyledFilterInput, {
    ref,
    value,
...
function TitleWithFilter({
  ...
  const [filterShown, setShowFilter] = (0, import_react22.useState)(false);
  ...
  return import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(StyledTitleWithFilter, {
    ...
    width: 12,
    height: 8
  })), import_react22.default.createElement(TitleContainer, _extends2({}, drag ? bind() : {}, {
    drag,
    filterEnabled
  }), title === void 0 && drag ? import_react22.default.createElement("svg", {
    width: "20",
    height: "10",
    viewBox: "0 0 28 14",
    xmlns: "http://www.w3.org/2000/svg"
    ...
    cy: "12",
    r: "2"
  })) : title), filterEnabled && import_react22.default.createElement(Icon, {
    active: filterShown,
    ...
    clipRule: "evenodd"
  })))), import_react22.default.createElement(FilterWrapper, {
    toggled: filterShown
  }, import_react22.default.createElement(FilterInput, {
    ref: inputRef,
    setFilter,
    toggle
  })));
...
function LevaRoot(_ref) {
  ...
  const computedSetToggle = (0, import_react22.useMemo)(() => {
  ...
  if (!store || hidden)
    return null;
  return import_react22.default.createElement(ThemeContext.Provider, {
    value: themeContext
  }, import_react22.default.createElement(LevaCore, _extends2({
    store
  }, props3, {
...
var LevaCore = import_react22.default.memo(({
  store,
  rootClass,
  fill: _fill = false,
  flat: _flat = false,
  ...
  const [filter, setFilter] = (0, import_react22.useState)("");
  const tree = (0, import_react22.useMemo)(() => buildTree(paths, filter), [paths, filter]);
  ...
  globalStyles();
  return import_react22.default.createElement(PanelSettingsContext.Provider, {
    value: {
      hideCopyButton: _hideCopyButton
    }
  }, import_react22.default.createElement(StyledRoot, {
    ref: rootRef,
    className: rootClass,
    fill: _fill,
    flat: _flat,
  ...
  }, _titleBar && import_react22.default.createElement(TitleWithFilter, {
    onDrag: (point) => {
      set(point);
    ...
    filterEnabled,
    from: position
  }), shouldShow && import_react22.default.createElement(StoreContext.Provider, {
    value: store
  }, import_react22.default.createElement(TreeWrapper, {
    isRoot: true,
    fill: _fill,
...
function Leva(_ref) {
  ...
  return import_react22.default.createElement(LevaRoot, _extends2({
    store: levaStore
  }, props3));
}
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          render(import_react22.default.createElement(Leva, {
            isRoot: true
          }), rootEl);
        }
      }
...
function useControls(schemaOrFolderName, settingsOrDepsOrSchema, depsOrSettingsOrFolderSettings, depsOrSettings, depsOrUndefined) {
  ...
  const depsChanged = (0, import_react22.useRef)(false);
  const firstRender = (0, import_react22.useRef)(true);
  ...
  const [store] = (0, import_react22.useState)(() => (hookSettings === null || hookSettings === void 0 ? void 0 : hookSettings.store) || levaStore);
  const [initialData, mappedPaths] = (0, import_react22.useMemo)(() => store.getDataFromSchema(_schema), [store, _schema]);
  const [allPaths, renderPaths, onChangePaths, onEditStartPaths, onEditEndPaths] = (0, import_react22.useMemo)(() => {
    const allPaths2 = [];
    const renderPaths2 = [];
  ...
  const paths = (0, import_react22.useMemo)(() => store.orderPaths(allPaths), [allPaths, store]);
  const values = useValuesForPath(store, renderPaths, initialData);
  const set = (0, import_react22.useCallback)((values2) => {
    const _values = Object.entries(values2).reduce((acc, [p, v]) => Object.assign(acc, {
      [mappedPaths[p].path]: v
    }), {});
    store.set(_values, false);
  }, [store, mappedPaths]);
  const get = (0, import_react22.useCallback)((path) => store.get(mappedPaths[path].path), [store, mappedPaths]);
  (0, import_react22.useEffect)(() => {
...
var DebugLayerMaterial = import_react25.default.forwardRef(({
  children,
  ...props3
}, forwardRef2) => {
  var _ref$current, _ref$current2, _ref$current3;
  const ref = import_react25.default.useRef(null);
  (0, import_react25.useImperativeHandle)(forwardRef2, () => ref.current);
  const store = useCreateStore();
  const [layers, setLayers] = import_react25.default.useState({});
  const [path, setPath] = import_react25.default.useState(["", ""]);
  const textureLoader = (0, import_react25.useMemo)(() => new TextureLoader(), []);
  useControls({
    "Copy JSX": button(() => {
  ...
  const [args, otherProps] = (0, import_react25.useMemo)(() => getLayerMaterialArgs({
    ...props3,
    lighting: Lighting
  }), [props3, Lighting]);
  ...
  import_react25.default.useEffect(() => {
    ...
    if (updatedData) {
      ...
      const index2 = parseInt(split[0].split(" ~")[1]);
  ...
  import_react25.default.useLayoutEffect(() => {
    ...
    if (root) {
      ...
      levaRoot.render(import_react25.default.createElement(LevaPanel, {
        titleBar: {
  ...
  return import_react25.default.createElement(import_react25.default.Fragment, null, Object.entries(layers).map(([name, layers2], i) => import_react25.default.createElement(DynamicLeva, {
    key: `${name} ~${i}`,
    name,
    layers: layers2,
    store,
    setUpdate: setPath
  })), import_react25.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children));
});
...
var LayerMaterial = import_react25.default.forwardRef(({
  children,
  ...props3
}, forwardRef2) => {
  const ref = import_react25.default.useRef(null);
  ...
  const [args, otherProps] = (0, import_react25.useMemo)(() => getLayerMaterialArgs(props3), [props3]);
  return import_react25.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children);
});
...
var Depth = import_react25.default.forwardRef((props3, forwardRef2) => {
  return import_react25.default.createElement("depth_", _extends({
    args: getNonUniformArgs(props3),
    ref: forwardRef2
  }, props3));
});
var Color3 = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("color_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Noise = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("noise_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Fresnel = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("fresnel_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Gradient = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("gradient_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Matcap = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("matcap_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Texture2 = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("texture_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Displace = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("displace_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Normal = import_react25.default.forwardRef((props3, ref) => {
  return import_react25.default.createElement("normal_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
